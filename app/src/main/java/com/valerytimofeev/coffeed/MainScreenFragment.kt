...
import com.valerytimofeev.coffeed.adapters.RecyclerViewItem
import com.valerytimofeev.coffeed.data.PreviewItemCard
import com.valerytimofeev.coffeed.mainDatabase.CoffeeDatabase
import com.valerytimofeev.coffeed.databinding.FragmentMainScreenBinding
...
class MainScreenFragment : Fragment(R.layout.fragment_main_screen) {
    ...
    private suspend fun deleteItem(uid: Int) {
        ...
        if (fileToDelete.exists() && itemToDelete.photoUri != "android.resource://com.valerytimofeev.coffeed/drawable/coffee_photo") {
            fileToDelete.delete()
        }
