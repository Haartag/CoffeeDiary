...
import com.valerytimofeev.coffeed.data.Constants.FILE_NAME_FORMAT
import com.valerytimofeev.coffeed.data.Constants.REQUIRED_PERMISSIONS
import com.valerytimofeev.coffeed.data.Constants.TAG
import com.valerytimofeev.coffeed.databinding.FragmentCoffeePhotoBinding
import java.io.File
...
class CoffeePhotoFragment : Fragment(R.layout.fragment_coffee_photo) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var defaultCoffeePlaceholderUri =
            "android.resource://com.valerytimofeev.coffeed/drawable/coffee_photo"
        ...
        if (args.photoType == 1) {
            ...
            defaultCoffeePlaceholderUri =
                "android.resource://com.valerytimofeev.coffeed/drawable/details_photo"
        }
